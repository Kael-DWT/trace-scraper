...
class LearningAgent:
    ...
    def learn_navigation(self, url: str, html: str) -> dict[str, Any] | None:
        ...
        system = (
            ...
            "CRITICAL: Some sites (e.g. maizhongzi.cn) show a '\u8ffd\u6eaf\u7f51\u5740' (trace URL) row \n"
            "where clicking the link submits a form (POST) to the same URL to reveal full details. \n"
            "Set need_detail_page to true and detail_selector to the clickable trace URL element.\n"
            "MULTI-DEPTH: Some sites (e.g. hy315.cc) need TWO clicks for full detail. \n"
            "Page 1 has a trace URL link to Page 2, then Page 2 has a '\u67e5\u770b\u4ea7\u54c1\u8be6\u60c5' \n"
            "(view product detail) button. The system auto-tries multi-hop, so identify the first selector.\n"
            "Look for input[type=submit] with value='\u67e5\u770b\u4ea7\u54c1\u8be6\u60c5' or similar.\n"
